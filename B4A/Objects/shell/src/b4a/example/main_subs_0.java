...
genero.myClass = BA.getDeviceClass ("b4a.example.genero");
generopage.myClass = BA.getDeviceClass ("b4a.example.generopage");
generoservice.myClass = BA.getDeviceClass ("b4a.example.generoservice");
libro.myClass = BA.getDeviceClass ("b4a.example.libro");
libropage.myClass = BA.getDeviceClass ("b4a.example.libropage");
libroservice.myClass = BA.getDeviceClass ("b4a.example.libroservice");
